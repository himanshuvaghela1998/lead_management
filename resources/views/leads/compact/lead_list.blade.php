<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
    ...
    <tbody class="fw-bold text-gray-600">
        ...
        <tr id="user_{{$lead->secret}}">
            ...
            <td class="font_style"> <p id="lead_status_span_{{ $lead->secret }}" data-secret="{{ $lead->secret }}" class="capitalize-letter lead_status_span">{{ str_replace('_', ' ', $lead->status) }} </p>
                <div class="d-flex align-items-center">
                    <select name="status" id="lead_status_{{ $lead->secret }}" data-placeholder="Project Status..." class="form-select form-select-solid dropdown_style">
                    ...
                    <i id="lead_cross_btn_{{ $lead->secret }}" class="fa fa-xmark fa-solid solid-icon lead_cross_btn btn_style" data-secret="{{ $lead->secret }}"></i>
                </div>
            </td>
            <td class="font_style">
                ...
                <div class="d-flex align-items-center">
                    <select name="user_id" id="lead_assignee_{{ $lead->secret }}"  data-placeholder="Assign to a user" class="form-select form-select-solid dropdown_style">
                    ...
                    <i id="lead_cross_assignee_btn_{{ $lead->secret }}" class="fa fa-xmark fa-solid solid-icon lead_cross_assignee_btn btn_style" data-secret="{{ $lead->secret }}"></i>
                </div>
            </td>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4" data-kt-menu="true">
                        ...
                        @can('lead_update')
                            <div class="menu-item px-3">
                                <a class="menu-link px-3 subModule" href="{{ route('lead.edit', $lead->secret )}}">Edit</a>
                            </div>
                        @endcan
                        <!--end::Menu item-->
                        <!--begin::Menu item-->
